...
var stickyHeadher = new _StickyHeader2.default();
...
var MobileMenu = function () {
	...
	_createClass(MobileMenu, [{
		...
		value: function events() {
			this.menuIcon.click(this.toggleMenuIcon.bind(this));
		}
	}, {
		key: 'toggleMenuIcon',
		value: function toggleMenuIcon() {
...
var StickyHeader = function () {
	...
	_createClass(StickyHeader, [{
		...
		value: function createHeaderWaypoint(trigger) {
			var obj = this;
			new Waypoint({
				element: trigger[0],
		...
		value: function createSectionWaypoints(headerLinks) {
